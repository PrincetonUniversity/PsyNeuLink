...
# Bug
# 1) l. 109: If two processes branch off an input mechanism, then the system creates two instances of the input mechanism
# i.e. 'TargetAutomaticProcess' cannot be added to system
