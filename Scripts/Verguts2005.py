...
# Implements the Verguts, Fias & Stevens model : A model of exact small-number representaion. Psychonimic Bulletin &
# Review.
...
#                                            function=pnl.Linear,
#                                            name='NUMBER_INPUT')
number_input_layer = pnl.RecurrentTransferMechanism(size=12,
                                                     function=pnl.Linear(),       
...
number_line_hidden_layer = pnl.RecurrentTransferMechanism(size=2,                     # Define unit size
