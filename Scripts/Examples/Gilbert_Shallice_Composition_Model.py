...
# Gilbert_Shallice_System._add_required_node_role(WORD_OUTPUT_LAYER, pnl.NodeRole.TERMINAL)
# Gilbert_Shallice_System._add_required_node_role(COLOR_OUTPUT_LAYER, pnl.NodeRole.TERMINAL)
