...
# Control Parameters
signalSearchRange = np.arange(0.0, 2.1, 0.2) #like in MATLAB Umemoto[0.0:0.2:4.0]# needs to be adjusted
...
FlankerAutomaticProcess = pnl.Process(
    default_variable=[0],
    pathway=[Distractor_Stim, Automatic_Component, Decision], #
