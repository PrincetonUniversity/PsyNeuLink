...
def test_rumelhart_semantic_network_sequential():
...
def test_rumelhart_semantic_network_convergent():
...
def test_rumelhart_semantic_network_crossing():
...
test_rumelhart_semantic_network_convergent()
test_rumelhart_semantic_network_crossing()
