...
Middle_Weights = pnl.MappingProjection(
    ...
    matrix={
        ...
        pnl.FUNCTION: psyneulink.core.components.functions.stateful.integratorfunctions.AccumulatorIntegrator,
        pnl.FUNCTION_PARAMS: {
...
z = pnl.Pathway(
    ...
    pathway=[
        ...
        # since its sender and receiver args are not specified in its
        # declaration above
        Input_Weights,
        Hidden_Layer_1,
