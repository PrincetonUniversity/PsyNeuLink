...
Gilbert_Shallice_System.add_required_c_node_role(WORD_OUTPUT_LAYER, pnl.CNodeRole.TERMINAL)
Gilbert_Shallice_System.add_required_c_node_role(COLOR_OUTPUT_LAYER, pnl.CNodeRole.TERMINAL)
