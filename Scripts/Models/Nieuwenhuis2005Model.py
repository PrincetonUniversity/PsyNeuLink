...
decision_layer = pnl.LCA(size=3,                            # Number of units in input layer
                     ...
                     # noise=UniformToNormalDist(standard_dev = SD).function, # The UniformToNormalDist function will
...
response_layer = pnl.LCA(size=2,                                        # Number of units in input layer
                     ...
                     # noise=UniformToNormalDist(standard_dev = SD).function,
...
ax.plot(t, LC_results_v, label="h(v)")      # Plot h(v)
