...
#region Mechanisms
Target = SigmoidLayer(name='Target', params={kwFunctionParams:{kwSigmoidLayer_Gain:(1.0, CONTROL_SIGNAL)}})
Distractor = SigmoidLayer(name='Distractor')


Decision = DDM(params={kwFunctionParams:{kwDDM_Threshold:(10.0, CONTROL_SIGNAL)},
