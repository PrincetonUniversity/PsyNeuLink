; ModuleID = "PsyNeuLinkModule-50"
target triple = "unknown-unknown-unknown"
target datalayout = ""

define void @"_ReLU_ReLU_Function_1__55"({[1 x double], [1 x double], [1 x double]}* noalias nonnull %".1", {}* noalias nonnull %".2", [1 x [25 x double]]* noalias nonnull %".3", [1 x [25 x double]]* noalias nonnull %".4") argmemonly!dbg !6
{
entry:
...
transfer_loop-cond-bb.if:
  ...
  %".9" = getelementptr [1 x [25 x double]], [1 x [25 x double]]* %".3", i32 0, i32 %"transfer_loop_loop_index_var" , !dbg !7
  %".10" = getelementptr [1 x [25 x double]], [1 x [25 x double]]* %".4", i32 0, i32 %"transfer_loop_loop_index_var" , !dbg !7
...
nested_transfer_loop-cond-bb:
  ...
  %"nested_transfer_loop_loop_cond" = icmp slt i32 %"nested_transfer_loop_cond_index_var", 25 , !dbg !7
...
nested_transfer_loop-cond-bb.if:
  ...
  %".14" = getelementptr [25 x double], [25 x double]* %".9", i32 0, i32 %"nested_transfer_loop_loop_index_var" , !dbg !7
  %".15" = getelementptr [25 x double], [25 x double]* %".10", i32 0, i32 %"nested_transfer_loop_loop_index_var" , !dbg !7
  %"ptr_param_gain_ReLU Function-1" = getelementptr {[1 x double], [1 x double], [1 x double]}, {[1 x double], [1 x double], [1 x double]}* %".1", i32 0, i32 2 , !dbg !7
  %"ptr_param_bias_ReLU Function-1" = getelementptr {[1 x double], [1 x double], [1 x double]}, {[1 x double], [1 x double], [1 x double]}* %".1", i32 0, i32 0 , !dbg !7
  %"ptr_param_leak_ReLU Function-1" = getelementptr {[1 x double], [1 x double], [1 x double]}, {[1 x double], [1 x double], [1 x double]}* %".1", i32 0, i32 1 , !dbg !7
  %".16" = load [1 x double], [1 x double]* %"ptr_param_gain_ReLU Function-1", !dbg !7
  %".17" = extractvalue [1 x double] %".16", 0 , !dbg !7
  %".18" = load [1 x double], [1 x double]* %"ptr_param_bias_ReLU Function-1", !dbg !7
  %".19" = extractvalue [1 x double] %".18", 0 , !dbg !7
  %".20" = load [1 x double], [1 x double]* %"ptr_param_leak_ReLU Function-1", !dbg !7
...
!6 = distinct !DISubprogram(file: !2, isLocal: false, line: 0, name: "_ReLU_ReLU_Function_1__55", type: !4, unit: !5)
