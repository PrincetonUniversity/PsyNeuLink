; ModuleID = "PsyNeuLinkModule-34"
target triple = "unknown-unknown-unknown"
target datalayout = ""

define void @"_LinearCombination_LinearCombination_Function_31__35"({double, {}, double, {}}* noalias nonnull %".1", {}* noalias nonnull %".2", [1 x [1 x double]]* noalias nonnull %".3", [1 x double]* noalias nonnull %".4") argmemonly!dbg !6
{
entry:
...
linear-cond-bb:
  ...
  %"linear_loop_cond" = icmp slt i32 %"linear_cond_index_var", 1 , !dbg !7
...
linear-cond-bb.if:
  ...
  %"ptr_param_scale_LinearCombination Function-31" = getelementptr {double, {}, double, {}}, {double, {}, double, {}}* %".1", i32 0, i32 2 , !dbg !7
  %".9" = load double, double* %"ptr_param_scale_LinearCombination Function-31", !dbg !7
  %"ptr_param_offset_LinearCombination Function-31" = getelementptr {double, {}, double, {}}, {double, {}, double, {}}* %".1", i32 0, i32 0 , !dbg !7
  %".10" = load double, double* %"ptr_param_offset_LinearCombination Function-31", !dbg !7
...
combine-cond-bb.if:
  ...
  %".15" = getelementptr [1 x [1 x double]], [1 x [1 x double]]* %".3", i32 0, i32 %"combine_loop_index_var", i32 %"linear_loop_index_var" , !dbg !7
  %".16" = load double, double* %".15", !dbg !7
  %"ptr_param_exponents_LinearCombination Function-31" = getelementptr {double, {}, double, {}}, {double, {}, double, {}}* %".1", i32 0, i32 3 , !dbg !7
  %"ptr_param_weights_LinearCombination Function-31" = getelementptr {double, {}, double, {}}, {double, {}, double, {}}* %".1", i32 0, i32 1 , !dbg !7
...
combine-cond-bb.endif:
  ...
  %".26" = getelementptr [1 x double], [1 x double]* %".4", i32 0, i32 %"linear_loop_index_var" , !dbg !7
...
!6 = distinct !DISubprogram(file: !2, isLocal: false, line: 0, name: "_LinearCombination_LinearCombination_Function_31__35", type: !4, unit: !5)
