; ModuleID = "PsyNeuLinkModule-63"
target triple = "unknown-unknown-unknown"
target datalayout = ""

define void @"_ReLU_ReLU_Function_2__69"({[1 x double], [1 x double], [1 x double]}* noalias nonnull %".1", {}* noalias nonnull %".2", [1 x [8 x double]]* noalias nonnull %".3", [1 x [8 x double]]* noalias nonnull %".4") argmemonly!dbg !6
{
entry:
...
nested_transfer_loop-cond-bb.if:
  ...
  %"ptr_param_gain_ReLU Function-2" = getelementptr {[1 x double], [1 x double], [1 x double]}, {[1 x double], [1 x double], [1 x double]}* %".1", i32 0, i32 2 , !dbg !7
  %"ptr_param_bias_ReLU Function-2" = getelementptr {[1 x double], [1 x double], [1 x double]}, {[1 x double], [1 x double], [1 x double]}* %".1", i32 0, i32 0 , !dbg !7
  %"ptr_param_leak_ReLU Function-2" = getelementptr {[1 x double], [1 x double], [1 x double]}, {[1 x double], [1 x double], [1 x double]}* %".1", i32 0, i32 1 , !dbg !7
  %".16" = load [1 x double], [1 x double]* %"ptr_param_gain_ReLU Function-2", !dbg !7
  %".17" = extractvalue [1 x double] %".16", 0 , !dbg !7
  %".18" = load [1 x double], [1 x double]* %"ptr_param_bias_ReLU Function-2", !dbg !7
  %".19" = extractvalue [1 x double] %".18", 0 , !dbg !7
  %".20" = load [1 x double], [1 x double]* %"ptr_param_leak_ReLU Function-2", !dbg !7
...
!6 = distinct !DISubprogram(file: !2, isLocal: false, line: 0, name: "_ReLU_ReLU_Function_2__69", type: !4, unit: !5)
