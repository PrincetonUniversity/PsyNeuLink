; ModuleID = "PsyNeuLinkModule-58"
target triple = "unknown-unknown-unknown"
target datalayout = ""

define void @"_Linear_Linear_Function_22__64"({double, double}* noalias nonnull %".1", {}* noalias nonnull %".2", [1 x double]* noalias nonnull %".3", [1 x double]* noalias nonnull %".4") argmemonly!dbg !6
{
entry:
...
transfer_loop-cond-bb.if:
  ...
  %"ptr_param_slope_Linear Function-22" = getelementptr {double, double}, {double, double}* %".1", i32 0, i32 0 , !dbg !7
  %"ptr_param_intercept_Linear Function-22" = getelementptr {double, double}, {double, double}* %".1", i32 0, i32 1 , !dbg !7
  %".11" = load double, double* %"ptr_param_slope_Linear Function-22", !dbg !7
  %".12" = load double, double* %"ptr_param_intercept_Linear Function-22", !dbg !7
...
!6 = distinct !DISubprogram(file: !2, isLocal: false, line: 0, name: "_Linear_Linear_Function_22__64", type: !4, unit: !5)
