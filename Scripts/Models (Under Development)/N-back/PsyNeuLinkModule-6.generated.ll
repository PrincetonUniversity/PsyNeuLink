; ModuleID = "PsyNeuLinkModule-6"
target triple = "unknown-unknown-unknown"
target datalayout = ""

define void @"_LinearCombination_LinearCombination_Function_37__6"({double, {}, double, {}}* noalias nonnull %".1", {}* noalias nonnull %".2", [2 x [25 x double]]* noalias nonnull %".3", [25 x double]* noalias nonnull %".4") argmemonly!dbg !6
{
entry:
...
linear-cond-bb.if:
  ...
  %"ptr_param_scale_LinearCombination Function-37" = getelementptr {double, {}, double, {}}, {double, {}, double, {}}* %".1", i32 0, i32 2 , !dbg !7
  %".9" = load double, double* %"ptr_param_scale_LinearCombination Function-37", !dbg !7
  %"ptr_param_offset_LinearCombination Function-37" = getelementptr {double, {}, double, {}}, {double, {}, double, {}}* %".1", i32 0, i32 0 , !dbg !7
  %".10" = load double, double* %"ptr_param_offset_LinearCombination Function-37", !dbg !7
...
combine-cond-bb:
  ...
  %"combine_loop_cond" = icmp slt i32 %"combine_cond_index_var", 2 , !dbg !7
...
combine-cond-bb.if:
  ...
  %".15" = getelementptr [2 x [25 x double]], [2 x [25 x double]]* %".3", i32 0, i32 %"combine_loop_index_var", i32 %"linear_loop_index_var" , !dbg !7
  %".16" = load double, double* %".15", !dbg !7
  %"ptr_param_exponents_LinearCombination Function-37" = getelementptr {double, {}, double, {}}, {double, {}, double, {}}* %".1", i32 0, i32 3 , !dbg !7
  %"ptr_param_weights_LinearCombination Function-37" = getelementptr {double, {}, double, {}}, {double, {}, double, {}}* %".1", i32 0, i32 1 , !dbg !7
...
!6 = distinct !DISubprogram(file: !2, isLocal: false, line: 0, name: "_LinearCombination_LinearCombination_Function_37__6", type: !4, unit: !5)
