; ModuleID = "PsyNeuLinkModule-127"
target triple = "unknown-unknown-unknown"
target datalayout = ""

define void @"_Linear_Linear_Function_58__138"({double, double}* noalias nonnull %".1", {}* noalias nonnull %".2", [2 x double]* noalias nonnull %".3", [2 x double]* noalias nonnull %".4") argmemonly!dbg !6
{
entry:
...
transfer_loop-cond-bb:
  ...
  %"transfer_loop_loop_cond" = icmp slt i32 %"transfer_loop_cond_index_var", 2 , !dbg !7
...
transfer_loop-cond-bb.if:
  ...
  %".9" = getelementptr [2 x double], [2 x double]* %".3", i32 0, i32 %"transfer_loop_loop_index_var" , !dbg !7
  %".10" = getelementptr [2 x double], [2 x double]* %".4", i32 0, i32 %"transfer_loop_loop_index_var" , !dbg !7
  %"ptr_param_slope_Linear Function-58" = getelementptr {double, double}, {double, double}* %".1", i32 0, i32 0 , !dbg !7
  %"ptr_param_intercept_Linear Function-58" = getelementptr {double, double}, {double, double}* %".1", i32 0, i32 1 , !dbg !7
  %".11" = load double, double* %"ptr_param_slope_Linear Function-58", !dbg !7
  %".12" = load double, double* %"ptr_param_intercept_Linear Function-58", !dbg !7
...
!6 = distinct !DISubprogram(file: !2, isLocal: false, line: 0, name: "_Linear_Linear_Function_58__138", type: !4, unit: !5)
