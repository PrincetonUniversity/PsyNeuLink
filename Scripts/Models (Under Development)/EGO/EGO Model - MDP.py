...
def construct_model(model_name:str=MODEL_NAME,
    ...
    def encoding_control_function(variable,context):
        ...
        #      ADD COUNTER (IntegratorMechanism with SimpleIntegrator function)
        #      ADD MODULATION OF ITS RESET Parameter BY CONTROL
        #      ADD CONTROL SIGNAL FOR GATING INPUT TO COUNTER AND DECISION
