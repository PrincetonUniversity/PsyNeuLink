...
#   - USE PREVIOUS STATE (WM) + CONTEXT (PRE-INTEGRATION) TO RETRIEVE PREDICTION OF CURRENT STATE
#   - ENCODE PREVIOUS STATE (WM) + CURRENT STATE (INPUT) + CONTEXT (PRE-INTEGRATION) INTO EM
#   - UPDATE CONTEXT LAYER:  INTEGRATE CURRENT STATE (INPUT) IN CONTEXT LAYER:
#   SO:
#   - EM SHOULD EXECUTE FIRST:
#     - RETRIEVE USING PREVIOUS STATE (WM) NODE AND CONTEXT (PRE-INTEGRATION) TO RETRIEVE PREDICTED CURRENT STATE
#     - STORE VALUES OF PREVIOUS STATE (WM), CURRENT STATE (INPUT) AND CONTEXT (PRE-INTEGRATION) INTO EM
