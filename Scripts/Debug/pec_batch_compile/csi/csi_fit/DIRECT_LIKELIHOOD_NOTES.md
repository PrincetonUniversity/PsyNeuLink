...
```bash
uv run python Scripts/Debug/pec_batch_compile/csi/csi_fit/csi_fitting_readiness.py \
...
```bash
python Scripts/Debug/pec_batch_compile/csi/csi_fit/csi_direct_solution_distributions.py \
...
```bash
python Scripts/Debug/pec_batch_compile/csi/csi_fit/csi_gpu_llvm_simulation_audit.py \
