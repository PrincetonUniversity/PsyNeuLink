...
export CSI_DATA_FILE="$CSI_REPO_ROOT/Scripts/Debug/pec_batch_compile/csi/csi_fit/data fitting/data_to_fit_study3.csv"
source "$CSI_REPO_ROOT/Scripts/Debug/pec_batch_compile/csi/csi_fit/handoff/environment.sh"
```
...
python Scripts/Debug/pec_batch_compile/csi/csi_fit/csi_likelihood_parameter_sweep.py \
...
python Scripts/Debug/pec_batch_compile/csi/csi_fit/csi_likelihood_sweep_report.py \
  "$CSI_AUDIT_ROOT"
```
