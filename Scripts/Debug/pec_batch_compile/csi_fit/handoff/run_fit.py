...
def arguments():
    ...
    cpu.add_argument("--gain-upper-bound", type=float, default=35.0)
    cpu.add_argument("--threshold-upper-bound", type=float, default=0.25)
    cpu.add_argument("--non-decision-time-upper-bound", type=float, default=0.4)
