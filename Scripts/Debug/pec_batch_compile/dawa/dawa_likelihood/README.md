...
PYTHONWARNINGS=ignore .venv/bin/python \
  Scripts/Debug/pec_batch_compile/dawa/dawa_direct_likelihood.py validate \
...
.venv/bin/python Scripts/Debug/pec_batch_compile/dawa/dawa_direct_likelihood.py score \
...
.venv/bin/python Scripts/Debug/pec_batch_compile/dawa/dawa_direct_likelihood.py fit \
