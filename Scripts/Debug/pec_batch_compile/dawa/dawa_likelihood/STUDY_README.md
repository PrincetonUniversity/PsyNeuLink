...
PYTHONWARNINGS=ignore .venv/bin/python \
  Scripts/Debug/pec_batch_compile/dawa/dawa_continuous_study.py \
  --output /tmp/dawa_continuous_study

# Native backends need the environment's Ninja executable on PATH.
source .venv/bin/activate

python Scripts/Debug/pec_batch_compile/dawa/dawa_continuous_recovery.py \
...
python Scripts/Debug/pec_batch_compile/dawa/dawa_continuous_profile.py \
  --output /tmp/dawa_profile.json

# Use the optional faster backends for ordinary sequential scoring as well.
python Scripts/Debug/pec_batch_compile/dawa/dawa_continuous_likelihood.py score \
