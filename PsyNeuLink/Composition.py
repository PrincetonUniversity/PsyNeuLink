...
class Composition(object):
    ...
    def scheduler_processing(self):
        '''
            The default `Scheduler` automatically generated by the Composition, used for the processing phase of execution, see :ref:`_System_Execution_Processing`
    ...
    def scheduler_learning(self):
        '''
            The default `Scheduler` automatically generated by the Composition, used for the learning phase of execution, see :ref:`_System_Execution_Learning`
