...
required to reduce the ``errorSignal`` generated by its ``errorSource`` (i.e, the ProcessingSystem monitored by the
MonitoringMechanism from which the LearningSignal recevies the ``errorSignal``).
