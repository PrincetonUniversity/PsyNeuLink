...
def _instantiate_parameter_state(owner, param_name, param_value, context):
    ...
    # Exclude function (see docstring above)
        ...
        return
    # (7/19/17 CW) added this if statement below while adding `cross` and `auto` and AutoAssociativeProjections: this
    # allows `cross` to be specified as a matrix, while still generating a ParameterState
