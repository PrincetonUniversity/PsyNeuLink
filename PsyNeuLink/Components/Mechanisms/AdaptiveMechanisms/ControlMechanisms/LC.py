...
<https://www.ncbi.nlm.nih.gov/pubmed/12371518>`_ that, together with a `UtilityIntegrator` Mechanism,
implements a form of the `Adaptive Gain Theory
<http://www.annualreviews.org/doi/abs/10.1146/annurev.neuro.28.061604.135709>`_ of LC function.  The LCMechanism
uses a `FitzHughNagumoIntegration` Function to simulate the regultion of LC funtion from tonic to phasic mode.
