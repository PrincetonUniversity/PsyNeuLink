...
from PsyNeuLink.Globals.Keywords import FUNCTION, INITIALIZING, MEAN, MEDIAN, NOISE, RESULT, STANDARD_DEVIATION, TRANSFER_FUNCTION_TYPE, TRANSFER_MECHANISM, VARIANCE, kwPreferenceSetName, INITIALIZER, NOISE, RATE
