...
.. note::
   ...
   operate in :keyword:`trial` mode, and some operate in :keyword:`time_step` mode;  however, mixed
   execution and coordination has not yet been fully implemented and debugged.
