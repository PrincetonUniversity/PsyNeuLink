# -*- coding: utf-8 -*-
#
# PsyNeuLink documentation build configuration file, created by
...
release = getattr(psyneulink, "__version__", "0+unknown")
...
htmlhelp_basename = 'PsyNeuLinkdoc'
...
latex_documents = [
    (master_doc, 'PsyNeuLink.tex', u'PsyNeuLink Documentation',
     u'Jon Cohen', 'manual'),
]
...
man_pages = [
    (master_doc, 'psyneulink', u'PsyNeuLink Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PsyNeuLink', u'PsyNeuLink Documentation',
     author, 'PsyNeuLink', 'One line description of project.',
     'Miscellaneous'),
]
