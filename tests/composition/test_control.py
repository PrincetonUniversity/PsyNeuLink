...
class TestControllers:
    ...
    def test_evc(self):
        ...
        # for node in comp.c_nodes:
        #     print(node.name, " value  = ", node.value)
#         # rearranging comp.results into a format that we can compare with pytest
#         results_array = []
...
#         #
#         # # comp.simulation_results expected output properly formatted
