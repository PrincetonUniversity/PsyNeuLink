...
class TestInitialize:
    ...
    def test_initialize_cycles(self, context_specified):
        ...
        abc_Composition.initialize_cycles({C: 2.0}, context=context)
    ...
    def test_initialize_cycles_excluding_unspecified_nodes(self):
        ...
        # initialize B to 0
        comp.initialize_cycles({B: 0}, include_unspecified_nodes=False)
    ...
    def test_initialize_cycles_using_default_keyword(self):
        ...
        comp.initialize_cycles({A: DEFAULT, B: DEFAULT, C: DEFAULT})
    ...
    def test_initialize_cycles_error(self):
        ...
        error_text = (
            f"{a.name} [(]entry in initialize_cycles values arg[)] is not a node in '{comp.name}'"
        )
        with pytest.raises(CompositionError, match=error_text):
            comp.initialize_cycles({a: 1})
