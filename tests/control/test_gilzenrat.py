...
class TestGilzenratMechanisms:
    ...
    def test_fhn_gilzenrat_figure_2(self):
        ...
        np.testing.assert_allclose(plot_v_list, [0.2, 0.05909943340633818, 0.10107987675017796, 0.1338424907134651, 0.16097210837561773, 0.18434302689966375, 0.20502920773046743, 0.22368293798355704, 0.24071214284201525, 0.25637044619630417, 0.2708052723781645])

        np.testing.assert_allclose(plot_w_list, [0.0, 0.0, 0.0005880491876738687, 0.0015879595786871168, 0.002903914150793959, 0.0044767189621682454, 0.00626641862892002, 0.008244141424794106, 0.010387793267253725, 0.01267955883694572, 0.015104323679781359])
