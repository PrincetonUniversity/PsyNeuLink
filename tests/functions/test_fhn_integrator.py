...
test_data = [
    (psyneulink.core.components.functions.statefulfunctions.integratorfunctions.FHNIntegratorFunction, test_var, "RK4", params, ([0.23619944, 0.24032298, 0.22321782, 0.43865125, 0.42363054,
    ...
    (psyneulink.core.components.functions.statefulfunctions.integratorfunctions.FHNIntegratorFunction, test_scalar, "RK4", params,
     ([0.33803257], [0.21641212], 0.15000000000000002)),
    (psyneulink.core.components.functions.statefulfunctions.integratorfunctions.FHNIntegratorFunction, test_var, "EULER", params, ([0.23686576, 0.24093183, 0.22404678, 0.43291206, 0.41863405,
                                                                                                                                    0.44273909,
    ...
    (psyneulink.core.components.functions.statefulfunctions.integratorfunctions.FHNIntegratorFunction, test_scalar, "EULER", params, ([0.33642314], [0.21013003], 0.15000000000000002)),
]

# use list, naming function produces ugly names
names = [
    "FHNIntegratorFunction RK4 VECTOR",
    "FHNIntegratorFunction RK4 SCALAR",
    "FHNIntegratorFunction EULER VECTOR",
    "FHNIntegratorFunction EULER SCALAR",
]
