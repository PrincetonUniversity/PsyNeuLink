...
class TestUserDefFunc:
    ...
    def test_autogenerated_udf_creates_parameters(self, mech_with_autogenerated_udf):
        assert hasattr(mech_with_autogenerated_udf.function_object.parameters, 'p')
        assert hasattr(mech_with_autogenerated_udf.function_object.parameters, 'q')

        assert mech_with_autogenerated_udf.function_object.parameters.p.default_value == 0
        assert mech_with_autogenerated_udf.function_object.parameters.q.default_value == 1

        assert not hasattr(mech_with_autogenerated_udf.function_object.class_parameters, 'p')
        assert not hasattr(mech_with_autogenerated_udf.function_object.class_parameters, 'q')
