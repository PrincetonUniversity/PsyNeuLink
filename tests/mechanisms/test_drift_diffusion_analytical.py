...
def check_drift_diffusion_analytical(B, data, degenerate_cases=False):
    ...
    stim, drift_rate, threshold, starting_value, bias, t0, noise, mean ER, mean RT,
    ...
    for i in range(NUM_CHECKS):
        r_stim, r_drift_rate, r_threshold, r_starting_value, r_bias, r_t0, r_noise = data[i, 0:7].tolist()
