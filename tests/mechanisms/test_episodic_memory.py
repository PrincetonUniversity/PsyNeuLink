...
# # test_initializer = {tuple([test_var, test_var])}
#
# test_data_2 = [
#     (test_var, ContentAddressableMemory, {'default_variable':test_var}, [
#        [0.5488135039273248, 0.7151893663724195, 0.6027633760716439],
#        [0.7917250380826646, 0.5288949197529045, 0.5680445610939323]]),
#     (test_var, ContentAddressableMemory, {'default_variable':test_var, 'retrieval_prob':0.5}, np.zeros(SIZE)),
#     (test_var, ContentAddressableMemory, {'default_variable':test_var, 'storage_prob':0.1}, np.zeros(SIZE)),
...
# ]
#
# # Test using ContentAddressableMemory
# @pytest.mark.function
# @pytest.mark.memory_function
# @pytest.mark.benchmark
# @pytest.mark.parametrize('variable, func, params, expected', test_data_2, ids=names)
# def test_with_content_addressable_memory(variable, func, params, expected, benchmark, mech_mode):
#     f = func(seed=0, **params)
#     m = EpisodicMemoryMechanism(default_variable=variable, function=f)
#     if mech_mode == 'Python':
#         def EX(variable):
#             m.execute(variable)
