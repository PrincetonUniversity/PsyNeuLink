...
class TestLossMechanism:
    ...
    def test_LossMechanism_construction(self):
        ...
        # TEACHER_TARGET BREADCRUMB: THIS FAILLS AS loss_mech IS NOT AUTOMATICALLY ADDED TO COMP
        ...
        comp = pnl.AutodiffComposition(pathways=[pway1,pway2,pway3,solo_input_mech],
                                       targets={pway1_mech_B: pway2_mech_B.output_port,
                                                ...
                                                pway3_mech_B: pnl.LossMechanism(sample=pway3_mech_B.output_port,
                                                                                target=solo_input_mech)})
        ...
        assert loss_mechs[4].target == solo_input_mech.output_port
