function [allERs,allDTs,allRRs,allFinalRTs,NDDMs,scaledX0,allFinalRTs_sepCDFs] = AS_ddmSimFRG_Mat(RVs,P,thresh, noise, t0,flipChoiceProb,actualChoices,sepCDFs,numNDDMsims)
