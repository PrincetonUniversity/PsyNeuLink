classdef DDM_RewardPerturb < Simulations.DDMSim
    
    % description of class
    % runs a simulation with reward manipulations of the current task (cf Padmala & Pessoa, 2011)
    ...
    methods
        ...
        function this = DDM_RewardPerturb()
            ...
            this.writeLogFile = 1; 
            this.logFileName = 'DDM_RewardPerturb'; 
