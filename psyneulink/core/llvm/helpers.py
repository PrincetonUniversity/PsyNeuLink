...
class ConditionGenerator:
    ...
    def generate_sched_condition(self, builder, condition, cond_ptr, node, is_finished_flags=None):
        ...
        from psyneulink.core.scheduling.condition import All, AllHaveRun, Always, AtPass, AtTrial, EveryNCalls, BeforeNCalls, AtNCalls, AfterNCalls, Never, WhenFinished
