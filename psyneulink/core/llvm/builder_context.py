...
class LLVMBuilderContext:
    ...
    def print_stats(self):
        ...
        print("  Object function cache: {} hits, {} misses".format(self._stats["cache_requests"] - self._stats["cache_misses"], self._stats["cache_misses"]))
        for stat in ("input", "output", "param", "state", "data"):
            gen_stat = self._stats[stat + "_structs_generated"]
