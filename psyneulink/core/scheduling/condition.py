...
For example, the following script fragment re-implements the BeforeEveryTrial Condition. It inserts the owner
Component in a new consideration set before the 1st consideration set of the base consideration queue that will
execute only once per trial::
