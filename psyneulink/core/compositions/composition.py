...
.. _LearningProjection_Output_vs_Terminal_Figure:
    ...
    **OUTPUT** vs. **TERMINAL** Roles in Learning Configuration
    ...
    .. figure:: _static/LearningMechanism_OUTPUT_vs_TERMINAL_fig.svg
       ...
       (e.g., ``add_backpropagation_learning_pathway(pathway=[A,B,C])`` and
       ``add_backpropagation_learning_pathway(pathway=[D,B])``)
       ------------
       Mechanism C is the last Mechanism for Process A, However, it is also an `INTERNAL` Mechanism of Process B.
