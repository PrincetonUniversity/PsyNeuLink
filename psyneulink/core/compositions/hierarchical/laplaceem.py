...
#: Shapes the group covariance may take.  See `fit_laplace_em`.
...
def fit_laplace_em(
    ...
    *,
    ...
    if covariance not in COVARIANCE_KINDS:
        raise ValueError(
            f"covariance must be one of {list(COVARIANCE_KINDS)}; got {covariance!r}"
        )
