...
from psyneulink.core.globals.keywords import \
    (ACCELERATING_DECAY_FUNCTION, ACCUMULATOR_INTEGRATOR_FUNCTION, ADAPTIVE_INTEGRATOR_FUNCTION, ADDITIVE_PARAM, \
     DECAY, DEFAULT_VARIABLE, DRIFT_DIFFUSION_INTEGRATOR_FUNCTION, DRIFT_ON_A_SPHERE_INTEGRATOR_FUNCTION, \
     DUAL_ADAPTIVE_INTEGRATOR_FUNCTION, END, EXPONENTIAL_DECAY_FUNCTION, FITZHUGHNAGUMO_INTEGRATOR_FUNCTION, FUNCTION, \
     ...
     OUTPUT_PORTS, PREVIOUS_VALUE, PRODUCT,  RATE, REST, SCALE, SIMPLE_INTEGRATOR_FUNCTION, START, SUM, TIME_STEP_SIZE,
...
__all__ = ['SimpleIntegrator', 'AdaptiveIntegrator', 'DriftDiffusionIntegrator', 'DriftOnASphereIntegrator',
           ...
           'ExponentialDecay', 'AcceleratingDecay', 'LeakyCompetingIntegrator', 'DualAdaptiveIntegrator',
...
class ExponentialDecay(IntegratorFunction):  # ---------------------------------------------------------------------------
    """
    ExponentialDecay(      \
         default_variable, \
         start=1.0,        \
...
class AcceleratingDecay(IntegratorFunction):  #
    # ---------------------------------------------------------------------------
    """
    AcceleratingDecay(     \
         default_variable, \
