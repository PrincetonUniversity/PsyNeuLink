...
class LinearCombination(
    ...
    def _gen_llvm_combine(self, builder, index, ctx, vi, vo, params):
        ...
        for i in range(vi.type.pointee.count):
            ...
            exponent = self._gen_llvm_load_param(ctx, builder, params,
                                                 EXPONENTS, exponent_index, 1.0)
            ...
            weight = self._gen_llvm_load_param(ctx, builder, params, WEIGHTS,
                                               ctx.int32_ty(i), 1.0)
            ...
            if isinstance(weight.type, pnlvm.ir.ArrayType):
                ...
                weight = builder.extract_value(weight, [0])
