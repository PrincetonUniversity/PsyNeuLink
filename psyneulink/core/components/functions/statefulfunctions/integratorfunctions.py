...
from psyneulink.core.globals.keywords import \
    ...
    INTEGRATOR_FUNCTION, INTEGRATOR_FUNCTION_TYPE, ACCURACY_INTEGRATOR_FUNCTION, REWARD_RATE_INTEGRATOR_FUNCTION
...
__all__ = ['SimpleIntegrator', 'AdaptiveIntegrator', 'DriftDiffusionIntegrator',
           ...
           'S_MINUS_L', 'L_MINUS_S', 'AccuracyIntegrator', 'RewardRateIntegrator'
           ]
...
class RewardRateIntegrator(IntegratorFunction):  # -------------------------------------------------------------------------
    """
    SimpleIntegrator(           \
        default_variable=None,  \
        rate=1.0,               \
    ...
    *Modulatory Parameters:*
    ...
    componentName = REWARD_RATE_INTEGRATOR_FUNCTION
