...
from psyneulink.core.globals.keywords import \
    (ACCELERATING_DECAY_FUNCTION, ADAPTIVE, ADDITIVE_PARAM, ALL, ANGLE_FUNCTION, BIAS, BINOMIAL_DISTORT_FUNCTION,
     DROPOUT_FUNCTION, END, EXPONENTIAL_FUNCTION, EXPONENTIAL_DECAY_FUNCTION, GAIN,
     GAUSSIAN_DISTORT_FUNCTION, GAUSSIAN_FUNCTION, IDENTITY_FUNCTION, INTERCEPT,
     LEAK, LINEAR_FUNCTION, LOGISTIC_FUNCTION, MAX_INDICATOR, MAX_VAL, MULTIPLICATIVE_PARAM,
     OFF, OFFSET, ON, OUTPUT_TYPE, PER_ITEM, PROB, PRODUCT, PROB_INDICATOR,
     RATE, RELU_FUNCTION, SCALE, SLOPE, SOFTMAX_FUNCTION, STANDARD_DEVIATION, START, SUM,
     TANH_FUNCTION, TOLERANCE, TRANSFER_FUNCTION_TYPE, TRANSFER_WITH_COSTS_FUNCTION,
...
__all__ = ['Angle', 'BinomialDistort', 'Dropout', 'Exponential', 'ExponentialDecay', 'AcceleratingDecay', 
           'Gaussian', 'GaussianDistort', 'Identity', 'Linear', 'Logistic', 'ReLU', 'SoftMax', 'Tanh',
           'TransferFunction', 'TransferWithCosts'
           ]
...
class AcceleratingDecay(TransferFunction):  # 
    # ---------------------------------------------------------------------------
    """
    AcceleratingDecay(     \
         default_variable, \
