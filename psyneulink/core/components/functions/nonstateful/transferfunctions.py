...
from psyneulink.core.globals.keywords import \
    (ACCELERATING_DECAY_FUNCTION, ADAPTIVE, ADDITIVE_PARAM, ALL, ANGLE_FUNCTION, BIAS, BINOMIAL_DISTORT_FUNCTION,
     DROPOUT_FUNCTION, END, EXPONENTIAL_DECAY_FUNCTION, EXPONENTIAL_FUNCTION,
     GAIN, GAUSSIAN_DISTORT_FUNCTION, GAUSSIAN_FUNCTION,
     ...
     PER_ITEM, PROB, PRODUCT, PROB_INDICATOR,
