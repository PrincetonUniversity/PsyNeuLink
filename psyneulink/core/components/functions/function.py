...
from psyneulink.core.globals.keywords import ARGUMENT_THERAPY_FUNCTION, BACKPROPAGATION_FUNCTION, \
    ...
    GAUSSIAN, \
    GRADIENT_OPTIMIZATION_FUNCTION, GRID_SEARCH_FUNCTION, HEBBIAN_FUNCTION, KOHONEN_FUNCTION, LEARNING_FUNCTION_TYPE, LEARNING_RATE, LINEAR, \
    MATRIX, NAME, OPTIMIZATION_FUNCTION_TYPE, OWNER, PARAMETER_STATE_PARAMS, \
    RL_FUNCTION, TDLEARNING_FUNCTION, VALUE, VARIABLE, \
    kwComponentCategory, kwPreferenceSetName
from psyneulink.core.globals.parameters import Param
from psyneulink.core.globals.preferences.componentpreferenceset import is_pref_set, kpReportOutputPref
from psyneulink.core.globals.preferences.preferenceset import PreferenceEntry, PreferenceLevel
from psyneulink.core.globals.registry import register_category
from psyneulink.core.globals.utilities import call_with_pruned_args, is_numeric, \
...
__all__ = [
    ...
    'DESCENT', 'DISABLE', 'DISABLE_PARAM', 'EPSILON',
    ...
    'MultiplicativeParam', 'OptimizationFunction', 'OVERRIDE', 'OVERRIDE_PARAM', 'PERTINACITY', 'PROPENSITY',
    'Reinforcement', 'ReturnVal',
    'SEARCH_FUNCTION', 'SEARCH_SPACE', 'SEARCH_TERMINATION_FUNCTION', 'TDLearning',
