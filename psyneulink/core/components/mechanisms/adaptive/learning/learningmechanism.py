...
.. _LearningMechanism_Single_Layer_Learning_Figure.svg:
    ...
    **Components for Single Layer Learning**
    ...
    .. figure:: _static/LearningMechanism_Single_Layer_Learning_Figure.svg
       ...
       (e.g., ``add_backpropagaption_learning_pathway(pathway=[A, B]``), labeled by type of Component (in **bold**,
       ...
       of the LearningMechanism that refers to the Component (*italicized* lower case, outside of object). The
