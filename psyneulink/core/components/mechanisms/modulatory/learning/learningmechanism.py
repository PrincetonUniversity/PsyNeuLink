...
displayed using the Composition's `show_graph`show_graph <ShowGraph_show_graph_Method>` method with its
...
<ShowGraph_show_graph_Method>``show_graph <ShowGraph_show_graph_Method>` method with
