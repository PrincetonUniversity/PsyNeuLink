...
# FIX: 8/1/23 - THIS NEEDS TO ACCOMODATE LEARNING FOR MECHANISMS WITH FUNCTIONS THAT HAVE MORE THAN ONE ARGUMENT
#               (E.G., LinearCombination), SO THAT THE RELEVANT JACOBIAN CAN BE COMPUTED BY THE
#               THE FUNCTION'S DERIVATIVE FOR EACH INPUT
#               NEED TO EITHER:
#               - HAVE NUMBER OF ACTIVATION INPUTS THAT CORRESPOND TO NUMBER OF ARGS TO THE FUNCTION;
#               - OR COULD MAKE ACTIVATION_INPUT 2D, WITH EACH EACH ITEM OF THE FIRST DIMENSION CORRESPONDING TO AN
#                 ARGUMENT OF THE FUNCTION (I.E., DIFFERENT ACTIVATION_INPUT)
#               IN EITHER CASE, FIRST ITEM MUST BE ACTIVATION_INPUT FROM WEIGHTS BEING LEARNED, OR AN INDEX OF THAT ONE
#                 HAS TO BE PROVIDED, WITH OTHERS FROM OTHER SOURCES THAT PROVIDE ARGUMENTS TO THE ACTIVATION FUNCTION.
