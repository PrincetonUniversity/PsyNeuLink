...
__all__ = [
    ...
    'GATING_PROJECTION', 'GATING_PROJECTION_PARAMS', 'GATING_PROJECTIONS', 'GATING_SIGNAL', 'GATING_SIGNAL_SPECS',
    'GATING_SIGNALS', 'GAUSSIAN', 'GILZENRAT_INTEGRATOR_FUNCTION', 'GRADIENT_OPTIMIZATION_FUNCTION',
