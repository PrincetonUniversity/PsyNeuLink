...
__all__ = [
    ...
    'LEAKY_COMPETING_INTEGRATOR_FUNCTION', 'LEAK', 'LEARNED_PROJECTION', 'LEARNING_FUNCTION_TYPE', 'LEARNING_MECHANISM', 'LEARNING_PROJECTION',
    ...
    'NAME', 'NOISE', 'NORMAL_DIST_FUNCTION', 'NORMED_L0_SIMILARITY',
    ...
    'VECTOR', 'WALD_DIST_FUNCTION', 'WEIGHT', 'WEIGHTS', 'X_0', 'ACCURACY_INTEGRATOR_FUNCTION', 'REWARD_RATE_INTEGRATOR_FUNCTION'
]
...
ACCURACY_INTEGRATOR_FUNCTION = 'Accuracy Integrator Function'
REWARD_RATE_INTEGRATOR_FUNCTION = 'Reward Rate Integrator Function'
