...
__all__ = [
    ...
    'COMPOSITION', 'COMPOSITION_FUNCTION_APPROXIMATOR', 'COMPOSITION_INTERFACE_MECHANISM', 'CONCATENATE',
    ...
    'EM_COMPOSITION', 'EM_COMPOSITION_PROJ', 'EM_STORAGE_FUNCTION', 'EM_STORAGE_MECHANISM', 'END',
    'EPISODIC_MEMORY_MECHANISM', 'EPOCH', 'EPOCHS', 'EQUAL', 'ERROR', 'ERROR_DERIVATIVE_FUNCTION', 'EUCLIDEAN',
    'EVC_MECHANISM', 'EVC_SIMULATION',
    'EXAMPLE_FUNCTION_TYPE', 'EXCLUDE', 'EXECUTE_UNTIL_FINISHED', 'EXECUTING',
    'EXECUTION', 'EXECUTION_COUNT', 'EXECUTION_ID', 'EXECUTION_MODE', 'EXECUTION_PHASE', 'EXTERNAL',
    'EXPONENT', 'EXPONENTS', 'EXPONENTIAL', 'EXPONENTIAL_DIST_FUNCTION', 'EXPONENTIAL_FUNCTION',
    'FEEDBACK', 'FITZHUGHNAGUMO_INTEGRATOR_FUNCTION', 'FINAL', 'FIRST', 'FLAGS', 'FULL', 'FULL_CONNECTIVITY_MATRIX',
    ...
    'IDENTITY_MATRIX', 'INCLUDE', 'INCREMENT', 'INDEX',
    ...
    'LAST', 'LAST_INTEGRATED_VALUE', 'INTERCEPT', 'INTERNAL', 'INTERNAL_ONLY',
    ...
    'Loss', 'LOSS', 'LOSSES', 'LOSS_FUNCTION', 'LOSS_MECHANISM', 'LOSS_PROJECTION',
    ...
    'MatrixKeywords', 'MATRIX_MEMORY_FUNCTION', 'MATRIX_TRANSFORM_FUNCTION',  'MATRIX_WEIGHTS',
    ...
    'NORMAL_DIST_FUNCTION', 'NORMALIZE', 'NORMALIZE_FUNCTION', 'NORMED_L0_SIMILARITY',
    ...
    'ORNSTEIN_UHLENBECK_INTEGRATOR_FUNCTION', 'ORTHOGONAL_MATRIX',
    'OUTCOME', 'OUTCOME_FUNCTION', 'OUTPUT', 'OUTPUTS', 'OUTPUT_CIM_NAME', 'OUTPUT_LABELS_DICT',
    ...
    'RETAIN_IN_PNL_OPTIONS', 'RETRIEVE', 'ROLES', 'RL_FUNCTION', 'RUN',
    ...
    'TARGET', 'TARGETS', 'TARGET_MECHANISM', 'TARGET_LABELS_DICT', 'TERMINAL',
    ...
    'SAMPLE_MECHANISM', 'SAMPLE_VALUES', 'TRAINING_SET', 'TRAJECTORY',
    ...
    'VECTOR', 'WALD_DIST_FUNCTION', 'WARNING', 'WEIGHT', 'WEIGHTS', 'X_0', 'XAVIER_MATRIX',
    'ZEROS_MATRIX', 'SHARED_COMPONENT_TYPES',
]
...
XAVIER_MATRIX = "XavierMatrix"
ORTHOGONAL_MATRIX = "OrthogonalMatrix"
...
EM_COMPOSITION_PROJ = 'EMComposition_Proj'
...
MATRIX_MEMORY_FUNCTION = "MatrixMemory Function"
...
NORMALIZE_FUNCTION = "Normalize Function"
