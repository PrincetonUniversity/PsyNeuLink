...
__all__ = [
    'ACCELERATING_DECAY_FUNCTION', 'ACCUMULATOR_INTEGRATOR', 'ACCUMULATOR_INTEGRATOR_FUNCTION',
    ...
    'TIME', 'TIME_STEP_SIZE', 'TIME_STEPS_DIM', 'TOLERANCE', 'TRAINED_OUTPUTS', 'TRAINING_SET',
