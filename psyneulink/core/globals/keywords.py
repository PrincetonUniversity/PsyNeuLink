...
__all__ = [
    ...
    'MAX_ABS_VAL', 'MAX_ABS_INDICATOR', 'MAX_ABS_DIFF', 'MAX_EXECUTIONS_UNTIL_FINISHED', 'MAX_INDICATOR', 'MAX_VAL',
    'MAYBE',
...
NUM_EXECUTIONS_UNTIL_FINISHED = 'num_executions_until_finished'
MAX_EXECUTIONS_UNTIL_FINISHED = 'max_executions_until_finished'
