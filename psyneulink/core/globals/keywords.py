...
__all__ = [
    ...
    'EXPONENTIAL', 'EXPONENTIAL_DIST_FUNCTION', 'EXPONENTIAL_FUNCTION', 'EXPONENTIA_DECAY_FUNCTION',
    ...
    'LOG_ENTRIES', 'ACCELERATING_DECAY_FUNCTION', 'DECELERATING_RISE_FUNCTION', 'LOGISTIC_FUNCTION',
    'Loss', 'LOSSES', 'LOW', 'LVOC_CONTROL_MECHANISM',
...
# TimerFunctions:
EXPONENTIA_DECAY_FUNCTION = "ExponentialDecay Function"
