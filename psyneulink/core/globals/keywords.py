...
__all__ = [
    ...
    'CONTROLLER', 'CONTROLLER_OBJECTIVE_MECHANISM', 'CORRELATION', 'COSINE', 'COST_FUNCTION', 'COUNT', 'CROSS_ENTROPY',
...
TARGET = 'TARGET'
ERROR = 'ERROR'
CONTROLLER_OBJECTIVE_MECHANISM = 'CONTROLLER_OBJECTIVE_MECHANISM'
