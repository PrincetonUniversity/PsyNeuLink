...
__all__ = [
    ...
    'CHANGED', 'CLAMP_INPUT', 'COLLAPSING_BOUND_MECHANISM', 'COMBINATION_FUNCTION_TYPE',
    ...
    'LINEAR_TRANSFORM_FUNCTION', 'LOG_ENTRIES', 'LOGISTIC_FUNCTION', 'Loss', 'LOSSES', 'LOW', 'LVOC_CONTROL_MECHANISM',
    ...
    'MATRIX_WEIGHTS', 'MAX_ABS_DIFF', 'MAX_ABS_INDICATOR', 'MAX_ONE_HOT', 'MAX_ABS_ONE_HOT', 'MAX_ABS_VAL',
    ...
    'PREFERENCE_SET_NAME', 'PREF_LEVEL', 'PREFS', 'PREFS_OWNER', 'PREVIOUS_VALUE', 'PRIMARY',
...
COLLAPSING_BOUND_MECHANISM = 'CollapsingBoundMechanism'
