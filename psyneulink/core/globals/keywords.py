...
__all__ = [
    ...
    'LEARNING_SCALE', 'LEARNING_SCALE_KEYWORDS', 'LEARNING_SCALE_NAMES', 'LEARNING_SIGNAL', 'LEARNING_SIGNAL_SPECS',
...
LEARNING_SCALE_LITERALS = Literal[tuple(LEARNING_SCALE_NAMES)]
