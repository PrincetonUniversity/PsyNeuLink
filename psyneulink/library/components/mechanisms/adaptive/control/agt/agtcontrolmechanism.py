...
class AGTControlMechanism(ControlMechanism):
   ...
   """
    ...
    def initial_short_term_utility(self):
        return self._objective_mechanism.function_object._initial_short_term_avg

    @initial_short_term_utility.setter
    def initial_short_term_utility(self, value):
        self._objective_mechanism.function_object.initial_short_term_avg = value

    @property
    def initial_long_term_utility(self):
        return self._objective_mechanism.function_object._initial_long_term_avg

    @initial_long_term_utility.setter
    def initial_long_term_utility(self, value):
        self._objective_mechanism.function_object.initial_long_term_avg = value
