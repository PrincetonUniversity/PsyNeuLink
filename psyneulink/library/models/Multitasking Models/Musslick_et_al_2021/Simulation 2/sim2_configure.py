...
thresh = 0              # mean-squared error stopping criterion
...
n_pathways = 2          # number of pathways (i.e. number of feature dimensions % output dimensions)
...
samples_per_task_train = 100   # stimuli per task for training (if samplesPerTask is empty then training patterns include entire space of stimuli per task)


def config():
    # Generate task envirnonment
    tasks_to_perform = [1, 2, 3, 4]
