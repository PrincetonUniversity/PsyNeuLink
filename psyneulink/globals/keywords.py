...
__all__ = [
    ...
    'REDUCE_FUNCTION', 'REFERENCE_VALUE', 'RESULT', 'RESULTS', 'RL_FUNCTION', 'RUN',
    'SAMPLE',
    ...
    'SYSTEM_INIT',
    'TARGET', 'TDLEARNING_FUNCTION', 'TERMINAL', 'THRESHOLD', 'TIME_SCALE', 'TIME_STEP_SIZE', 'TIME_STEPS_DIM',
    'TRANSFER_FUNCTION_TYPE',
    'TRANSFER_MECHANISM', 'TRIALS_DIM', 'UNCHANGED', 'UNIFORM_DIST_FUNCTION',
    'USER_DEFINED_FUNCTION',
    'USER_DEFINED_FUNCTION_TYPE', 'USER_PARAMS', 'UTILITY_INTEGRATOR_FUNCTION', 'VALIDATE',
