...
__all__ = [
    ...
    'LCA_INTEGRATOR_FUNCTION', 'LEARNING_FUNCTION_TYPE', 'LEARNING_MECHANISM', 'LEARNING_PROJECTION',
    ...
    'RECORDER_FUNCTION', 'REDUCE_FUNCTION', 'REFERENCE_VALUE', 'RESULT', 'RESULTS', 'ROLES', 'RL_FUNCTION', 'RUN',
...
UNCHANGED = 'UNCHANGED'
ENABLED = 'ENABLED'
REINITIALIZATION_ATTRIBUTES = '_reinitialization_attributes'
...
RECORDER_FUNCTION = 'Recorder Function'
