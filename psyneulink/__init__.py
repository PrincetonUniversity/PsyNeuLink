...
# set __version__ from the file generated by setuptools-scm at build time;
# fall back to installed package metadata (or a placeholder) for un-built trees
try:
    from ._version import __version__  # noqa: E402
except ImportError:
    from importlib.metadata import version as _pkg_version, PackageNotFoundError
    try:
        __version__ = _pkg_version("psyneulink")
