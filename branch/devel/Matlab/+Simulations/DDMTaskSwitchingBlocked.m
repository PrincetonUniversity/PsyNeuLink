classdef DDMTaskSwitchingBlocked < Simulations.DDMSim
    ...
    methods
        ...
        function this = DDMTaskSwitchingBlocked()
            import EVC.*;
            import EVC.DDM.*;
            ...
            temp.attractorFnc.params{1} = 10; %
            temp.attractorFnc.params{2} = -4.0;
...
%             subplot(3,1,3);
    ...
    methods (Access = protected)
        ...
        function initTaskEnv(this)
            ...
            this.taskEnv = TaskEnv.blockedTaskSwitchDesign(this.trials, this.nTrials, 60, trialProps);          
        end
