...
window.highlightNavigation = {
  ...
  bind: function() {
    ...
    for (var i = 0; i < highlightNavigation.sections.length; i++) {
      ...
      highlightNavigation.sectionIdTonavigationLink[id] =
        document.querySelectorAll('#psyneulink-right-menu li a[href="#' + id + '"]')[0];
    }
  ...
  highlight: function() {
    var rightMenu = document.getElementById("psyneulink-right-menu");
    ...
    for (var i = (sections.length - 1); i >= 0; i--) {
      ...
      if (scrollPosition >= sectionTop - offset) {
        ...
        if (navigationListItem && !navigationListItem.classList.contains("active")) {
          ...
          // var menuTop = $("#psyneulink-right-menu").position().top;
          // var itemTop = navigationListItem.getBoundingClientRect().top;
          // var TOP_PADDING = 20
          // var newActiveTop = $("#psyneulink-side-scroll-right").scrollTop() + itemTop - menuTop - TOP_PADDING;

          // $("#psyneulink-side-scroll-right").animate({
...
window.sideMenus = {
  ...
  bind: function() {
    ...
    var rightMenuLinks = document.querySelectorAll("#psyneulink-right-menu li");
    ...
    if (rightMenuHasLinks) {
      ...
      document.getElementById("psyneulink-shortcuts-wrapper").style.display = "block";
      ...
      var titleLinks = document.querySelectorAll(
        "#psyneulink-right-menu #psyneulink-side-scroll-right \
      ...
      var menuLinks = document.querySelectorAll(
        "#psyneulink-right-menu ul li ul li a.reference.internal"
      );
      ...
      var linkWithHash =
        document.querySelector(
          "#psyneulink-right-menu a[href=\"" + window.location.hash + "\"]"
        );
      ...
      $("#psyneulink-right-menu a.reference.internal").on("click", function() {
  ...
  leftMenuIsFixed: function() {
    return document.getElementById("psyneulink-left-menu").classList.contains("make-fixed");
  },
  ...
  handleNavBar: function() {
    ...
    if (utilities.scrollTop() >= mainHeaderHeight) {
      ...
      document.getElementById("psyneulink-page-level-bar").classList.add("left-menu-is-fixed");
    } else {
      document.getElementById("psyneulink-left-menu").classList.remove("make-fixed");
      document.getElementById("psyneulink-page-level-bar").classList.remove("left-menu-is-fixed");
    }
  },
  ...
  handleLeftMenu: function () {
    ...
    if (topOfFooterRelativeToWindow >= windowHeight) {
      document.getElementById("psyneulink-left-menu").style.height = "100%";
    } else {
      ...
      document.getElementById("psyneulink-left-menu").style.height = (windowHeight - leftMenuDifference) + "px";
    }
  },

  handleRightMenu: function() {
    var rightMenuWrapper = document.getElementById("psyneulink-content-right");
    var rightMenu = document.getElementById("psyneulink-right-menu");
    var rightMenuList = rightMenu.getElementsByTagName("ul")[0];
    var article = document.getElementById("psyneulink-article");
    ...
    var rightMenuSideScroll = document.getElementById("psyneulink-side-scroll-right");
...
},{}],"psyneulink-sphinx-theme":[function(require,module,exports){
